...
use super::potentials::scalar::SombreroPotential;
...
// The `Potential` trait and the concrete 1D potentials (HarmonicPotential,
// SombreroPotential, DoubleWellPotential, ProtonTransferPotential) now live in
// `super::potentials`. The trait and the scalar potentials are imported at the
// top of this module.
