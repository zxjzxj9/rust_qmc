//! Multi-Atom PIMD -- Bifluoride HF2- Proton Transfer
//!
...
//! - Experimentally: very strong tunneling (~1000 cm-1 splitting)
...
fn main() {
    ...
    println!("|    pimd_bifluoride_distribution.txt -- P(d) histogram       |");
