...
//!
//! The sombrero potential: V(x) = -mu²x²/2 + lambdax⁴/4
...
fn main() {
    ...
    println!("  - At high T (small beta): classical, particle in one well");
    println!("  - At low T (large beta): quantum, wavefunction spreads over both wells");
